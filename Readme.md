...
# Дополнительно
* Joi (валидация)
* React-helmet (управление head информацией страницы)
...
Сервер доступен по адресу: https://11.react.pages.academy/wtw.
Спецификация по взаимодействию с сервером в формате OpenAPI — https://11.react.pages.academy/wtw/spec.
